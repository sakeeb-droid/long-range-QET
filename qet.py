...
class LongRangeQETCircuit(MinimalQETCircuit):
    def __init__(self, h, k, v_measure=False):
        ...
        self.creg_qt = ClassicalRegister(2, 'c_qt')
        self.creg_qet = ClassicalRegister(2, 'c_qet')
        self.qc = QuantumCircuit(self.qreg, self.creg_qt, self.creg_qet)
